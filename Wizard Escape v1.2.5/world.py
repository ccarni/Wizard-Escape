...
class Room(pygame.sprite.Sprite):
    ...
    def setup_level(self, screen, player):
        ...
        game_folder_name = 'Wizard Escape v1.2'
        with open(f'../{game_folder_name}/levels/{self.current_path}.txt', 'r') as level:
        ...
        for row in range(len(block_grid)):
            for column in range(len(block_grid[row])):
                ...
                #powerups
                    ...
                    h = powerup.Heart(screen,  art.draw_heart(screen), ((column * tilesize, row * tilesize)))
                    self.powerups.add(h)
                #trophies
                elif block_grid[row][column] == 't':
                    t = powerup.Trophy(screen,  art.draw_trophy(screen), ((column * tilesize, row * tilesize)))
                    self.powerups.add(t)
                elif block_grid[row][column] == 'i':
                    size = 40
                    t = powerup.Attack(screen,  art.draw_ice(screen, size), ((column * tilesize, row * tilesize)), attacks.ice, attacks.ice_cooldown)
                    self.powerups.add(t)
...
class World1(World):
    def __init__(self, runner):
        ...
        self.rooms_layout = [[None, None, None, None, None, None, None, None, None, None],
                             [None, None, self.roomw1, None, None, None, None, None, None, None],
                             [None, None, self.room9, None, None, None, None, None, None, None],
                             [None, None, self.room6, None, None, self.room17, self.room14, self.blank_room, self.blank_room,
                              None],
                             [None, None, self.room3, None, None, self.room16, None, None, self.room18, None],
                             [None, self.room1, self.room2, self.room4, None, self.room15, None, None, self.room19, None],
                             [None, self.start_room, None, self.room5, None, self.room14, self.room13, None, self.roomwin,
                              None],
                             [None, None, None, self.room7, None, self.room12, None, None, None, None],
                             [None, self.roomw2, self.room11, self.room8, self.room9, self.room10, None, None, None, None],
