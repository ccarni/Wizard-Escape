...
def draw_hud(screen, max_health, health, heart_size=50):
    ...
    for i in range(max_health):
        if (health - 1) >= i:
            ...
            heart = draw_empty_heart(screen)
        heart = pygame.transform.smoothscale(heart, (heart_size, heart_size))
